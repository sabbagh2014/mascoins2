...
const Edit = () => {
    ...
    return (
       ...
       <Paper elevation={2} style={{margin:"40px ",padding:"30px 10px",paddingBottom:'50px'}}  >
           <Box pl={5} mt={4} px={2}> <Typography variant="h3" style={{fontWeight:"1000"}}>  Edit Reach us </Typography>  </Box>
        <Box  mt={4} px={2}>
          ...
          <Grid item xs={12}> 
                    <Grid  container spacing={1} alignItems="center" justify="center">
                       ...
                       <Grid item > <Link to="/reachus" style={{textDecoration:'none'}}><Button type="submit" className={classes.btn2} variant="contained" > Cancel</Button></Link> </Grid>
                    </Grid>
          </Grid>
            </Grid>
            </Box>
