...
const View = () => {
  ...
  <Box >
        <Typography variant='h3' style={{marginTop:'20px', marginLeft:'15px'}} >View Left Side Data</Typography>
...
<Grid container direction="column" spacing={5}>
  ...
  <Box mt={2}>        <Grid container  justify="center" spacing={2}> 
       <Grid item > <Link to="/edit-left-side-data" style={{textDecoration:"none"}}><Button type="submit" className={classes.btn} variant="contained" > Edit</Button> </Link>  </Grid>
